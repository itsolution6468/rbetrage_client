...
import { Link as RouterLink, useMatch, useLocation, useNavigate } from 'react-router-dom';
...
function NavMenu({ menuChildren = [], Icon, title }) {
	...
	return (
		...
		>
			...
			<LoginModal openModal={showModal} setOpenModal={setShowModal} />
		</NavItemButton>
	);
}
