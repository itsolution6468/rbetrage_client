...
const blogs = [
    {
        ...
        summary: "In the competitive world of e-commerce, success stories often begin with a combination of passion, perseverance, and the right tools. Meet Alex Bennett, an aspiring entrepreneur whose journey into online retailing took a significant leap forward with Retail Arbitrage (RA) Dropshipping software.",
        createdAt: '30 Aug, 2024'
    },
    {
        imageUrl: image2,
        title: "Unleashing Potential: A Trailblazing Journey with Retail Arbitrage Dropshipping.",
        summary: "In the dynamic world of e-commerce, taking opportunities and optimizing operations are essential for success. Meet Emily Chang, a creative entrepreneur whose journey into online retail was transformed by Retail Arbitrage (RA) Dropshipping software.",
        createdAt: '29 Aug, 2024'
    },
    {
        imageUrl: image3,
        title: "Accelerating Growth: A Success Story with Retail Arbitrage Dropshipping",
        summary: "In the dynamic world of online retail, seizing opportunities and optimizing operations are crucial for sustained success. Meet Sarah Thompson, whose entrepreneurial journey took a significant leap forward with Retail Arbitrage (RA) Dropshipping software.",
        createdAt: '28 Aug, 2024'
    },
    {
        imageUrl: image4,
        title: "Revolutionizing E-commerce: The Rise of AI-Powered Product Sourcing",
        summary: "In the fast-evolving landscape of e-commerce, staying ahead means embracing innovation that reshapes how businesses operate. Discover how AI-powered product sourcing is revolutionizing the industry and transforming the fortunes of entrepreneurs like never before.",
        createdAt: '27 Aug, 2024'
    },
    {
        imageUrl: image5,
        title: "Empowering Single Mothers: A Journey to Successful Entrepreneurship",
        summary: "In today's entrepreneurial landscape, single mothers are breaking barriers and achieving great success by harnessing their strength, resourcefulness, and entrepreneurial energy.",
        createdAt: '29 Aug, 2024'
    },
    {
        imageUrl: image6,
        title: "How to Start and Succeed in a Family- Owned E - commerce Business",
        summary: "Launching a business experience with family members can be a rewarding journey filled with unique challenges and opportunities. This blog explores the essential steps and practical tips for launching and growing a successful family-owned e-commerce business, promoting collaboration, and achieving long-term success.",
        createdAt: '29 Aug, 2024'
    },
];
