...
import { Grid, Stack, Typography, CircularProgress, circularProgressClasses, Slider, TextField, Button, Select, MenuItem } from '@mui/material';
...
function FilteredProductPage() {
    ...
    const handleFilterProducts = () => {
        ...
        axios
            .get(`${BACKEND_API}/products/filtered_products?${query}`).
            then(res => {
                setProducts(res.data);
            })
    }
