...
function FacebookTrendingProductPage() {
	...
	return (
		<Box>
			<Helmet>
				<title>Facebook trends Page | Rbetrage</title>
				<meta name="description" content="Facebook trends page of rbetrage" />

				<link rel="canonical" href="https://rbetraj.com/trending/facebook" />
			</Helmet>
			<Box>
				<Stack
					sx={{
...
export default FacebookTrendingProductPage;
